...
Sumber Data: [Kaggle - Dataset Penguin Palmer]()
...
Pada tahap ini dilakukan analisis terhadap distribusikelas target (Species) pada dataset untuk memahami karakteristik data sebelum proses pemodelan. Pada Dataset, spesies Adelie Penguin memiliki 152 sampel (44,2%), Gentoo Penguin sebanyak 124 sampel (36,0%), dan Chinstrap Penguin sebanyak 68 sampel (19,8%).
